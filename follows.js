(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'ukgiyaIu6f88MzUum3MkSfbTRDtZRkIALWAlrHQqzfW4YAnP', // Unique master Xively API key to be used as a default
		defaultFeeds	= [1181590788], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Данные с датчиков', // Replaces Xively logo in the header
							...
							xively.datastream.history(feedId, datastream.id, {duration: duration, interval: interval, limit: 1000}, function(datastreamData) {
								...
								if(datastreamData.datapoints) {
									...
									datastreamData.datapoints.forEach(function(datapoint) {
										points.push({x: new Date(datapoint.at + 14400000).getTime()/1000.0, y: parseFloat(datapoint.value)});
									});
